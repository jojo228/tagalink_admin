...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Home Data Get Successfully!!!",'is_block'=>$is_block,"tax"=>$set['tax'],"currency"=>$set['currency'],"Recommend_car"=>$navsp);	
}
