        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Car Type List Management</h3>
                </div>
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                            <th>Sr No.</th>
							<th>Car Type Title</th>
											<th>Car Type Image</th>
												<th>Car Type Status</th>
												<th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $car->query("select * from car_type");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_car_type.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
