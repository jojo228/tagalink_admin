	...
	elseif($_POST["type"] == "make_decision")
	{
        ...
        elseif($_POST["type"] == "add_car")
            ...
            elseif ($_POST["type"] == "add_coupon") {
                    ...
                    $table = "tbl_coupon";
                    $field_values = ["status", "coupon_img", "title", "coupon_code", "min_amt", "coupon_val", "description", "subtitle", "expire_date"];
                    $data_values = ["$status", "$url", "$title", "$coupon_code", "$min_amt", "$coupon_val", "$description", "$subtitle", "$expire_date"];
