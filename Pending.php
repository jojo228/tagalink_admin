        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Total Pending Book Management</h3>
                </div>
          ...
          <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $car->query("SELECT * FROM `tbl_book` where book_status='Pending' order by id desc");
										$i=0;
