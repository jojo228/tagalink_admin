          ...
          <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
               ...
               <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $car->query("select * from tbl_gallery");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<img src="<?php $image = explode('$;',$row['img']); echo $image[0]; ?>" width="70" height="80"/>
												...
												<td class="align-middle">
                                                   <?php $pro = $car->query("select * from tbl_car where id=".$row['car_id']."")->fetch_assoc();echo $pro['car_title'];?>
                                                </td>
										   ...
										   <a href="add_gal.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
